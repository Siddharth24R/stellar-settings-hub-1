    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 to-black text-white p-4">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center py-10">
          <h2 className="text-3xl font-bold text-blue-300 mb-6">Recorded Clips</h2>
          <p className="text-lg text-blue-100 mb-10 max-w-md mx-auto">
            This page will contain your recorded clips once implemented.
          </p>
          ...
          <Card className="max-w-lg mx-auto bg-black/40 border border-blue-400/30 backdrop-blur-sm text-white">
            ...
            <CardContent>
              <p className="text-blue-100/70">
                Clip management features will be available in a future update.
              </p>
              <Button 
